...
from .views import ProcessCertificateView, CertificateMetadataView, UniversityCertificateListView, StudentCertificateListView
...
urlpatterns = [
    ...
    path('students/<str:student_id>/certificates/', StudentCertificateListView.as_view(), name='student_certificates'),
